...
//End single slider
//Trying to get double click event to switch to double slider
// var clickedOnce = false;
// var timer;

// d3.select(".handle").bind("click", function(){
    // if (clickedOnce) {
        // run_on_double_click();
    // } else {
        // timer = setTimeout(run_on_simple_click, 1000);
        // clickedOnce = true;
    // }
// });
...
// function brushstart() {
  // sliderSvg.classed("selecting", true);
// }
...
// function brushend() {
  // sliderSvg.classed("selecting", !d3.event.target.empty());
// }